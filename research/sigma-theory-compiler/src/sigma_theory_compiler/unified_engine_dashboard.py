...
<section><h2>Conformal G4 galaxy evaluator</h2><div class="metrics">{_metric('Decision', core['g4_galaxy_evaluator']['decision'])}{_metric('Forward-model registrations', core['g4_galaxy_evaluator']['forward_model']['filled_registration_hash_count'])}{_metric('Still missing', core['g4_galaxy_evaluator']['forward_model']['missing_registration_hash_count'])}{_metric('Analytic controls', str(core['g4_galaxy_evaluator']['forward_model']['analytic_known_answer_pass_count']) + '/3')}{_metric('Object-specific gravity parameters', core['g4_galaxy_evaluator']['object_specific_gravity_parameter_count'])}</div><p>Rotation and lensing implementations are now hash-bound for the exact scalar-free branch. Prediction bundle registered: {_escape(core['g4_galaxy_evaluator']['forward_model']['prediction_bundle_registered'])}. Observations opened: {_escape(core['g4_galaxy_evaluator']['forward_model']['observational_data_opened'])}. First missing premise: {_escape(core['g4_galaxy_evaluator']['forward_model']['first_missing_premise'])}.</p></section>
