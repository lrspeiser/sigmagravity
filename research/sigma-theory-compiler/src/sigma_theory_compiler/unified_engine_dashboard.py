...
<section><h2>Kastner–Schlatter transactional-gravity proposal</h2><div class="metrics">{_metric("Decision", transactional["decision"])}{_metric("Equation checks", transactional["equation_preflight_counts"]["pass"])}{_metric("Graph nodes", transactional["equation_graph"]["counts"]["nodes"])}{_metric("Registered fields", transactional["observational_readiness"]["registration_counts"]["by_status"]["source_registered"])}{_metric("Missing fields", transactional["observational_readiness"]["registration_counts"]["by_status"]["missing_required"])}{_metric("Observation access", transactional["observational_readiness"]["observational_access_count"])}{_metric("Synthetic power evals", transactional["cuda_falsification_design"]["counts"]["gpu_measured_value_evaluations"])}{_metric("Poisson alt detection", f'{100 * transactional["cuda_falsification_design"]["poisson_power_control"]["empirical_alternative_detection_rate"]:.2f}%')}{_metric("BTFR alt detection", f'{100 * transactional["cuda_falsification_design"]["btfr_power_control"]["empirical_alternative_detection_rate"]:.2f}%')}{_metric("Readiness advanced", transactional["cuda_falsification_design"]["counts"]["readiness_fields_advanced"])}{_metric("Scientific tests", transactional["cuda_falsification_design"]["counts"]["scientific_tests_passed"])}{_metric("Device-wide GPU mean", f'{transactional["cuda_falsification_design"]["runtime_measurement"]["utilization"]["gpu_percent_mean"]:.2f}%')}{_metric("Device-wide GPU max", f'{transactional["cuda_falsification_design"]["runtime_measurement"]["utilization"]["gpu_percent_max"]:.0f}%')}</div><p>The source-bound intake and typed graph represent the proposal as a dependency chain of 25 formulas, not one standalone proof. The observational contract registers 19 of 88 required fields, leaves 58 missing and four source-blocked, and opens zero observations. The second RTX 5090 campaign rehearses Poisson-overdispersion and point-mass BTFR group-residual falsification designs. Their synthetic alternatives are detected in 100% and 99.93% of registered replicates with byte-equal GPU/CPU decisions, but this advances zero readiness fields and performs zero scientific tests. Detector equivalence, extended-galaxy geometry, and Equation-35/Lambda propagation remain blocked. NVML figures are device-wide and not lane-exclusive. First broader blocker: {_escape(transactional["first_blocker"])}. Synthetic power and algebraic agreement do not establish the transactional ontology, a fundamental action, GR equivalence, dark-sector elimination, or observational validity.</p></section>
...
<section><h2>Fourth-order range closure</h2><div class="metrics">{_metric("Exact selector", core["quartic_nonlinear_closure"]["fourth_jet_range_obligations"]["selector_obligations"])}{_metric("Obligations closed", core["quartic_nonlinear_closure"]["fourth_jet_range_obligations"]["obligations_closed"])}{_metric("Unevaluated after stop", core["quartic_nonlinear_closure"]["fourth_jet_range_obligations"]["obligations_remaining"])}{_metric("Candidate obstructions", core["quartic_nonlinear_closure"]["fourth_jet_range_obligations"]["candidate_obstructed"])}{_metric("Polarization directions", core["quartic_nonlinear_closure"]["fourth_jet_range_obligations"]["canonical_obstruction_certificate"]["homogeneous_freedom_reduction"]["polarization_directions_checked"])}{_metric("Zero-projector checks", core["quartic_nonlinear_closure"]["fourth_jet_range_obligations"]["canonical_obstruction_certificate"]["homogeneous_freedom_reduction"]["total_exact_zero_projector_checks"])}{_metric("Lower-jet slots covered", core["quartic_nonlinear_closure"]["fourth_jet_range_obligations"]["canonical_obstruction_certificate"]["homogeneous_freedom_reduction"]["lower_jet_reference_kernel_slots_covered_by_identity"])}{_metric("Induced D4 map rank", core["quartic_nonlinear_closure"]["fourth_jet_range_obligations"]["canonical_obstruction_certificate"]["homogeneous_freedom_reduction"]["induced_D4_zero_eigenspace_map_rank"])}{_metric("Homogeneous cancellations", core["quartic_nonlinear_closure"]["fourth_jet_range_obligations"]["canonical_obstruction_certificate"]["homogeneous_freedom_reduction"]["candidate_cancellations"])}{_metric("Alternative lower jets ruled out", core["quartic_nonlinear_closure"]["fourth_jet_range_obligations"]["canonical_obstruction_certificate"]["alternative_lower_jet_homogeneous_completion_ruled_out"])}</div><p>The service closed 244 obligations and found an exact rank-two obstruction at selector offset 244 for all 12 candidates. The homogeneous-freedom reduction closes the previous caveat: on all 15 nonempty polarization sums through Taylor order four, the stationary-projector identity <code>R0^T(HP-P^T H)R0=0</code> and the mandatory lower recurrences make the induced D4 zero-eigenspace map identically rank zero. This covers all 20,842 lower-jet kernel slots, so no homogeneous lower-jet completion can cancel the witness. All 12 current candidates are invariantly obstructed; changing the candidate/operator ansatz or TC2 correction is now required. The remaining 2,816 obligations are unevaluated, and full D4, tube, CK1, CK3, TC2, B7, global H7, and lifespan remain false.</p></section>
