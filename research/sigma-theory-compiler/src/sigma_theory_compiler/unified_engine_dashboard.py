...
<section><h2>Current exact Aether and G3 boundary</h2><div class="metrics">{_metric("Aether C3 jet envelopes", core["grammar_parameter_cells"]["staged_epoch"]["reviewed_future_chunk"]["family_followup"]["aether"]["compact_profile_C3_weighted_jet_bound_pass_count"])}{_metric("Aether coefficient contracts", core["grammar_parameter_cells"]["staged_epoch"]["reviewed_future_chunk"]["family_followup"]["aether"]["lower_order_coefficient_contract_declared_count"])}{_metric("Aether canonical backgrounds", core["grammar_parameter_cells"]["staged_epoch"]["reviewed_future_chunk"]["family_followup"]["aether"]["full_canonical_background_point_registered_count"])}{_metric("Aether lower-order registries", core["grammar_parameter_cells"]["staged_epoch"]["reviewed_future_chunk"]["family_followup"]["aether"]["distributed_lower_order_coefficient_registry_complete_count"])}{_metric("G3 radial momentum audits", core["grammar_parameter_cells"]["staged_epoch"]["reviewed_future_chunk"]["family_followup"]["g3"]["radial_momentum_leading_order_pass_count"])}{_metric("G3 Hamiltonian audits", core["grammar_parameter_cells"]["staged_epoch"]["reviewed_future_chunk"]["family_followup"]["g3"]["flat_Hamiltonian_leading_order_pass_count"])}{_metric("Real joint coefficients", core["grammar_parameter_cells"]["staged_epoch"]["reviewed_future_chunk"]["family_followup"]["g3"]["joint_real_asymptotic_coefficient_solution_count"])}{_metric("Flat radial classes rejected", core["grammar_parameter_cells"]["staged_epoch"]["reviewed_future_chunk"]["family_followup"]["g3"]["flat_radial_matched_constraint_class_reject_count"])}</div><p>The sole uniformly elliptic Aether candidate now has an exact compact C3 profile jet envelope and a typed lower-order coefficient interface. It still lacks a full finite-tilt canonical seed point, including <code>pi^ij</code> and <code>p_A^i</code>, and the distributed Hamiltonian/momentum coefficient DAG; no weighted Fredholm, nonlinear-remainder, boundary-sign, or rejection result follows. For the three future G3 actions, real flat spherical AF York data with standard r^-2 falloff obey <code>alpha+2k=0</code> and <code>1-(2/3)k^2+(2/3)alpha^2=0</code>, hence <code>1+2k^2=0</code>. This excludes that matched data class, not the actions or theories. Nonflat, nonradial, different-falloff, and logarithmic or polyhomogeneous data remain open.</p></section>
  {future_dossier_html}
