...
def render_dashboard(snapshot: Mapping[str, Any]) -> str:
    ...
    mixed_supervisor = volatile.get(
        "mixed_third_jet_supervisor", {"availability": "not_configured"}
    )
