...
<section><h2>LLM budget and proposal quarantine</h2><div class="metrics">{_metric('Campaign budget', '$' + str(core['llm']['configured_budget_usd']))}{_metric('Campaign spent', '$' + str(core['llm']['spent_usd']))}{_metric('Adapter cap', '$' + core['llm']['proposal_adapter']['maximum_total_usd'])}{_metric('Adapter calls', core['llm']['proposal_adapter']['network_calls_made'])}{_metric('Bridge tasks admitted', core['llm']['campaign_bridge']['compiler_tasks_enqueued'])}</div><p>Adapter: {_escape(core['llm']['proposal_adapter']['status'])}. Campaign bridge: {_escape(core['llm']['campaign_bridge']['status'])}. Typed-DSL admission: {_escape(core['llm']['typed_dsl_admission']['status'])}. Paid calls and durable formula-body persistence are disabled by default; only exact hash-bound proposals can enter the separate reviewed compiler queue.</p></section>
