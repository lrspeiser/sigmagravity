...
SCHEMA_VERSION = "sigma-quartic-tc2-second-atom-chunk576-campaign-1.0"
CHUNK_OFFSET = 576
...
OBSTRUCTION_STATUS = (
    "exact_second_atom_Sylvester_obstruction_found_in_chunk576_global_H7_fail_closed"
)


def generic_second_atom_chunk576_boundary_control() -> tuple[bool, dict[str, Any]]:
    return generic_contiguous_boundary_control(CHUNK_OFFSET)


def run_quartic_tc2_second_atom_chunk576_campaign(
...
def write_quartic_tc2_second_atom_chunk576_campaign(
