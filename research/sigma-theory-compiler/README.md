...
The first deterministic second-order chunk now evaluates 64 canonical pairs across all 12
candidates. All 768 candidate equations admit exact Hermitian `deltaK_AB` corrections with zero
Sylvester residual and no obstruction. Stable global pair indices and a resume hash are recorded;
the other 11,717 pairs remain unevaluated and are not inferred.
