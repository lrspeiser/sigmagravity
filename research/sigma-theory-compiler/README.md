...
Two chained deterministic second-order chunks now evaluate 128 canonical pairs across all 12
candidates. All 1,536 candidate equations admit exact Hermitian `deltaK_AB` corrections with zero
Sylvester residual and no obstruction. The continuation verifies the prior record chain and resume
tip before extending it; the other 11,653 pairs remain unevaluated and are not inferred.
