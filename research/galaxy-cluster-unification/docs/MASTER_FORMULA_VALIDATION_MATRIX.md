...
| Cluster source dynamics | The response-aware A2319 run completed all seven NXB prefits and 21 source fits, but its public regional NXB model failed. V19CZ then preserved every additional shape freedom required by the independent official recipe; six regions still had reduced chi-square 10.97--17.96. The replacement V19DA Chandra preflight passes across all 5,082 cells and 20,328 archived products. V19DB combined all 43 Bullet primary regions from all 3,483 primary cells with exact count conservation; its worst direct-versus-hierarchical forward-fold difference is `5.65e-9`. V19DC passed the nine-ObsID Ni/Au gain audit. V19DD then built the 674,283-count integrated spectrum and all 387 regional response weights; its maximum direct-versus-hierarchical weight difference is `3.25e-8`. Effective regional gain uncertainty is 195--241 km/s, while fitted mean-correction dispersion is 472--587 km/s. The first V19DE source execution is invalid because XSPEC could not load the APEC continuum table. | Time-odd source not admitted. Freeze an AtomDB-bound positive-probe remediation before rerunning the integrated 2T/WStat profile. No V19DE APEC source value is admissible. The public Resolve-v1 small-subarray route is retired. Abell 2146 is internally sealed but nonpristine transfer. A3667 validation and A754 holdout remain sealed. |
