...
| Cluster source dynamics | The response-aware A2319 route failed because the public regional NXB model was unacceptable. The replacement Chandra chain passed exact combination, response, gain and transport checks, but V19DE2's integrated 2T profile had an unrejected second redshift minimum. V19DF then reconstructed all 156 public MACS J0018 members, but the all-member velocity gradient failed its shuffle null (`p=0.1313`), literature/Keck axial transfer (54.58 degrees) and bootstrap direction gate; the analysis-grade kSZ maps/covariance were not publicly attached. | Time-odd/component current not admitted. The Chandra closure may not be retuned, and the public MACS J0018 member field cannot calibrate a coupling. Preserve gas and galaxy components separately in future architectures, but obtain untouched analysis-grade kSZ/calorimeter products or another independent direct-velocity system before action selection. |
