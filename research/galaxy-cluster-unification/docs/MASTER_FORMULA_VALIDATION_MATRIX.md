...
| Cluster source dynamics | The response-aware A2319 run completed all seven NXB prefits and 21 source fits, but its public regional NXB model failed. V19CZ then preserved every additional shape freedom required by the independent official recipe; six regions still had reduced chi-square 10.97--17.96. The replacement V19DA Chandra preflight now passes across all 5,082 cells and 20,328 archived products, with one target-blind region rule frozen before any new redshift fit. | Time-odd source not admitted. The public Resolve-v1 small-subarray route is retired. Bullet is known-outcome Chandra development; Abell 2146 is internally sealed but nonpristine transfer. A3667 validation and A754 holdout remain sealed. |
