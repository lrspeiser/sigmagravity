...
| Cluster source dynamics | The response-aware A2319 route failed because the public regional NXB model was unacceptable. V19DE2's independent Bullet 2T closure then had an unrejected second redshift minimum. V19DF reconstructed all 156 public MACS J0018 members, but its gradient failed shuffle, catalog-transfer and bootstrap gates. In the separate thermodynamic-source lane, the 5,082-cell response archive is complete; direct V19X2 `addresp` failed before fitting, hierarchical V19DG2 changed sparse RMF structure and was rejected, while the independent V19DH direct-array arithmetic passed both prospective 128-cell controls with folded-spectrum differences below `8.80e-6`. | Time-odd/component current remains unadmitted. V19DH now authorizes a separately frozen OGIP writer/full-combination successor for the still-sealed I4 thermodynamic-gradient stress and I5 baroclinicity test. No temperature or invariant has yet been opened; do not derive an action until that source-only decision passes. |
