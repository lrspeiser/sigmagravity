...
def test_v19_observability_gate_does_not_pretend_to_be_a_formula() -> None:
    ...
    v19w3 = protocols["sigma_v19w3_full_response_recovery.json"]
    assert v19w3["role"] == "gate_or_data_protocol_no_new_formula_fragment"
    assert v19w3["formula_fragment_count"] == 0
