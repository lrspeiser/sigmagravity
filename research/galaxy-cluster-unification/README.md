...
observations. All 20 passed reprocessing, flare, compact-source, and matched
...
required freeze covers registration, X-ray edge/thermodynamic uncertainties,
and the projection/clock ensemble before any source is constructed.
