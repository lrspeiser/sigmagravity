#!/usr/bin/env python3
"""Download only the A383 files authorized by the frozen feasibility gate."""
...
FEASIBILITY_PATH = ROOT / "results/r1_a383_gemini_feasibility/report.json"
...
def main() -> None:
    ...
    if not feasibility["authorization"]["download_exact_frozen_raw_files"]:
        raise RuntimeError("A383 metadata feasibility gate did not authorize acquisition")
