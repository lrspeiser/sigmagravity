...
if (resolvedEvidence.systems.length !== 4 || resolvedEvidence.sample.scoredVelocityPixels !== 76182) {
  throw new Error("resolved twin evidence must contain four systems and 76,182 scored pixels");
}
