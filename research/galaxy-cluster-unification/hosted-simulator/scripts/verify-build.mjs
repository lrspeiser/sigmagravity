...
const requiredPaths = [
  ...
  "dist/schemas/production-model-registration-v1.schema.json",
  "dist/schemas/production-upload-registration-v1.schema.json",
  ...
  "lib/production-auth.mjs",
  "lib/production-api-handler.mjs",
  "lib/production-research-service.mjs",
  "lib/production-runtime.mjs",
  "lib/production-database.mjs",
  "lib/production-job-consumer.mjs",
  "lib/production-queue.mjs",
  "lib/advanced-plugin.mjs",
  "lib/advanced-plugin-launcher.mjs",
  "lib/stateless-worker-client.mjs",
  "sql/production-control-plane-v1.sql",
  "sql/production-research-api-v2.sql",
...
for (const phrase of [
  ...
  "Project-scoped durable research API",
