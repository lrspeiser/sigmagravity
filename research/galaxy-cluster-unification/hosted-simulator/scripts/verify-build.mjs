...
for (const path of ["index.html", "assets/app.js", "assets/style.css", "dist/index.html", "dist/assets/app.js", "dist/assets/style.css", "data/sparc-v1.json", "api/v1/runs.mjs"]) {
