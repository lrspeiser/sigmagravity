...
def build_accumulated_transport_deflection_field(
    ...
    *,
    ...
    if closure_id == "path_tensor":
        ...
        "streamline_diffused_gas_minus_star_flux",
    }:
        ...
        if closure_id == "streamline_diffused_gas_minus_star_flux":
            transported_x, transported_y, transport_audit = symmetric_field_line_diffusion(
