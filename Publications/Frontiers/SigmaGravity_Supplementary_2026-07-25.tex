...
This Supplement accompanies ``\(\Sigma\)-Gravity: A Coherence-Motivated Empirical Response Tested in Galaxies and Clusters.'' It documents the equations, data roles, exclusions, grouped uncertainty procedures, statistical checks, and software regression status used in the manuscript.
...
\tightlist
\item
  \href{https://github.com/lrspeiser/sigmagravity/blob/main/research/derivation_audit/results/qumond_axisymmetric_residuals.csv}{\passthrough{\lstinline!research/derivation\_audit/results/qumond\_axisymmetric\_residuals.csv!}}
\item
  \href{https://github.com/lrspeiser/sigmagravity/blob/main/research/derivation_audit/results/qumond_axisymmetric_summary.json}{\passthrough{\lstinline!research/derivation\_audit/results/qumond\_axisymmetric\_summary.json!}}
\item
  \href{https://github.com/lrspeiser/sigmagravity/blob/main/research/derivation_audit/results/qumond_grid_convergence.csv}{\passthrough{\lstinline!research/derivation\_audit/results/qumond\_grid\_convergence.csv!}}
\end{itemize}
...
\item
  \passthrough{\lstinline!research/derivation\_audit/results/fox\_parameter\_audit.json!}
\end{itemize}
...
\tightlist
\item
  \passthrough{\lstinline!research/derivation\_audit/results/tian\_fox\_frozen\_residuals.csv!}
\item
  \passthrough{\lstinline!research/derivation\_audit/results/tian\_cluster\_audit.json!}
\end{itemize}
...
\tightlist
\item
  \passthrough{\lstinline!research/derivation\_audit/results/counterrotation\_matched\_controls.csv!}
\item
  \passthrough{\lstinline!research/derivation\_audit/results/counterrotation\_smd\_before.csv!}
\item
  \passthrough{\lstinline!research/derivation\_audit/results/counterrotation\_smd\_after.csv!}
\item
  \passthrough{\lstinline!research/derivation\_audit/results/counterrotation\_readiness.json!}
\end{itemize}
