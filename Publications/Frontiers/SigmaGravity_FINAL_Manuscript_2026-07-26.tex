...
\begin{center}
\small Manuscript ID 1866133 \quad Word count: 4441 \quad Figures: 4 \quad Tables: 2
\end{center}
...
\subsection{A bounded-factor empirical response}\label{a-bounded-factor-empirical-response}
