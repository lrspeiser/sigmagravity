...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{../figures/amplitude_comparison.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{../figures/rar_comparison.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{../figures/rotation_curve_gallery.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{../figures/mw_rotation_curve.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{../figures/cluster_validation.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{../figures/counter_rotation_test.png}
...
\bibitem{Milgrom2010}
M. Milgrom, ``Quasi-linear formulation of MOND,'' Phys. Rev. D \textbf{82}, 043523 (2010).
...
\bibitem{Fox2022}
C. Fox, G. Mahler, K. Sharon, and J. D. Remolina Gonz\'{a}lez, ``The RELICS Strong Lensing Analysis,'' Astrophys. J. \textbf{928}, 87 (2022).
...
\bibitem{MaNGA2023}
MaNGA DynPop Collaboration, private communication (2023).
