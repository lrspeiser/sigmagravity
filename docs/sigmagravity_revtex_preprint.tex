...
\caption{Amplitude versus path length for 171 SPARC disk galaxies (green), 873 MaNGA ellipticals (orange), and 42 Fox et al. clusters (red). Blue: $\Sigma$-Gravity prediction. Red dashed: MOND. Gray: GR without dark matter.}
\label{fig:amplitude}
\end{figure}
