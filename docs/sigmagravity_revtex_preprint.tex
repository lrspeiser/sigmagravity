...
\hline
\end{tabular}
\caption{Parameter accounting. $L_0 \approx 0.4$ kpc corresponds to the typical disk scale height; $n$ was calibrated using 42 Fox et al. clusters. SPARC galaxies provide independent validation.}
\label{tab:params}
\end{table}
