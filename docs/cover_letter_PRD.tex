...
\begin{itemize}
\item Stacy McGaugh (Case Western Reserve University) --- Expert on SPARC data and MOND
\item Benoit Famaey (Observatoire astronomique de Strasbourg) --- Expert on modified gravity
\item Kfir Blum (Weizmann Institute) --- Expert on gravitational dynamics
\end{itemize}

\textbf{Excluded Referees}
