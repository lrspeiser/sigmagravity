...
\textbf{Theoretical framework:} The kernel structure is motivated by quantum path-integral reasoning—coherent superposition of near-geodesic families around the classical GR solution—but parameters {A, ℓ₀, p, n\_coh} are empirically calibrated.
The coherence window C(R) = 1-[1+(R/ℓ₀)^p]^(-n\_coh) employs a Burr-XII form justified by superstatistical decoherence models.
